function simulasi3(){
	...
	var graf = {startX:xGraph, startY:yGraph, dataW:5, dataH:8, tileW:40, skalaX:2, skalaY:0.4, desimalX:0, desimalY:1, offsetX:0, offsetY:0, xLabel:'t (s)', yLabel:'y (m)', fontLabel:'12pt Calibri', warnaBG:'#daf6fb', warnaGaris:'#000', warnaLabel:'#000'}
	...
	function setSimulasi() {
		...
		if (simAktif == 1) {  
			...
			teks("Simulasi gerakan bola pada lintasan melingkar", 0.5*(canvas.width), 60, "12pt Calibri", "#000", "center");
