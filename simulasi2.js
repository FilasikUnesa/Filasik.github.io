function simulasi2(){
	...
	var graf = {startX:180, startY:150, dataW:10, dataH:4, tileW:40, skalaX:10, skalaY:10, desimalX:0, desimalY:0, offsetX:0, offsetY:2, xLabel:'x (m)', yLabel:'y (m)', fontLabel:'12pt Calibri', warnaBG:'#daf6fb', warnaGaris:'#000', warnaLabel:'#000'}
	...
	function setSimulasi(){
		...
		//menampilkan teks
		teks("Gerak Parabola", 0.5*(canvas.width), 40, 'bold 18pt Calibri', 'blue', 'center');
		teks("Simulasi gerak peluru yang diluncurkan dengan kecepatan dan sudut tertentu", 0.5*(canvas.width), 75, "12pt Calibri", "#000");

		grafik(graf);

		teks("Kecepatan = "+vInit+ " m/s", 260, 440, "bold 13pt Calibri", "black", "left");
		slider(slider1);
		teks("Sudut = "+angle+ " ⁰", 260, 500, "bold 13pt Calibri", "black", "left");
		slider(slider2);
