function simulasi1(){
	...
	var graf = {startX:50, startY:140, dataW:16, dataH:3, tileW:40, skalaX:10, skalaY:10, desimalX:0, desimalY:0, offsetX:0, offsetY:1.5, xLabel:'x (m)', yLabel:'noaxis', fontLabel:'11pt Calibri', warnaBG:'#daf6fb', warnaGaris:'#000', warnaLabel:'#000'}
	...
	function setSimulasi(){
		...
		teks("Simulasi perbandingan pengaruh kecepatan dan akselerasi antara 2 objek", 0.5*(canvas.width), 75, "12pt Calibri", "#000", "center");

		grafik(graf);

		//slider
		teks("Mobil Merah", 50, 370, "bold 15pt Calibri", "red", "left");
		teks("Posisi Awal = "+x1Init+ " m", 50, 400, "bold 13pt Calibri", "black", "left");
		slider(slider1);
		teks("Kecepatan = "+v1+ " m/s", 50, 460, "bold 13pt Calibri", "black", "left");
		slider(slider2);
		teks("Akselerasi = "+a1+ " m/s²", 50, 520, "bold 13pt Calibri", "black", "left");
		slider(slider3);

		teks("Mobil Biru", 450, 370, "bold 15pt Calibri", "blue", "left");
		teks("Posisi Awal = "+x2Init+ " m", 450, 400, "bold 13pt Calibri", "black", "left");
		slider(slider4);
		teks("Kecepatan = "+v2+ " m/s", 450, 460, "bold 13pt Calibri", "black", "left");
		slider(slider5);
		teks("Akselerasi = "+a2+ " m/s²", 450, 520, "bold 13pt Calibri", "black", "left");
		slider(slider6);
		...
		teks(timeLabel, 50, 120, "bold 14pt Calibri", "#000", "left");
