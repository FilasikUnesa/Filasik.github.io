...
var inputNama = {nama:"nama", x:520, y:350, p:200, t:30, huruf:"13pt Calibri", val:"nama", max:30, limit:"*", warnaLayar:"#f0f0f0"};
...
function halamanJudul(){
	...
	gambar(dataGambar.judul, 300, 50);
...
function halamanNama(){
	...
	//teks html
	teksHTML("Selamat datang di <b>VIRTUAL LAB</b>, <br>sebelum memulai tuliskan nama anda terlebih dahulu !", 500, 280, 250, "12pt-Arial-center-1.6", "#690608");
	teksInput(inputNama);
	//tombol OK
...
function halamanMenu(){
	...
	tombol("Gerak dan Kecepatan/id=simulasi1", 450, 200, 300, 40, "bold 14pt Calibri", "white", "#d49715", "#d49715", "r");
	tombol("Gerak Parabola/id=simulasi2", 450, 250, 300, 40, "bold 14pt Calibri", "white", "#d49715", "#d49715", "r");
	tombol("Gerak Melingkar/id=simulasi3", 450, 300, 300, 40, "bold 14pt Calibri", "white", "#d49715", "#d49715", "r");	
}
		...
		if (tombolAktif == "cek_nama"){
			...
			if (inputNama.val == "nama" || inputNama.val == ""){
			 ...
			 //salam, setelah nama diinput
				...
				popup1.val = "Salam <b>"+namaPengguna+"</b>, selamat datang di <b>Virtual Lab</b>. Disini anda dapat mencoba beberapa simulasi Fisika";
			}
			popup(popup1); 
		}
